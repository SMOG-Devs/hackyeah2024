...
def vad_write_wave(path, audio, sample_rate):
    """Writes a .wav file.
...
def vad_collector(sample_rate, frame_duration_ms,
                  padding_duration_ms, vad, frames: List[Frame]):
    ...
    for frame in frames:
        ...
        if first and is_speech == 1:
            last = 1
            first = False
        elif first and is_speech == 0:
            last = 0
            start = frame.timestamp
            first = False
        elif last == 1 and is_speech == 0:
            last = 0
            start = frame.timestamp
        elif last == 0 and is_speech == 1:
            last = 1
